class PetriNetCanvas {
    ...
    showPNFN() {
        try {
            ...
            regenM0Btn.textContent = "Regenerate MΓéÇ";
    ...
    showGuide() {
        ...
        guideText.innerHTML = `
            ...
            - Displays the formal notation of the Petri Net(s) on the canvas as PN = {P, T, I, O, MΓéÇ}.<br>
            ...
            - MΓéÇ: Initial marking showing token counts for each place in a vertical matrix (e.g., MΓéÇ =<br>&nbsp;&nbsp;&nbsp;&nbsp;|  2 |<br>&nbsp;&nbsp;&nbsp;&nbsp;|  1 |<br>&nbsp;&nbsp;&nbsp;&nbsp;|  0 |).<br>
            - Multiple nets are detected if elements are unconnected and shown as 'Net 1', 'Net 2', etc.<br>
            - 'Regenerate MΓéÇ': Updates MΓéÇ to reflect current token counts.<br>
