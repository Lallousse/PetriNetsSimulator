import { Place, Transition, Initializer } from './elements.js';
    ...
    static save(canvas) {
        const design = {
            ...
            transitions: canvas.transitions.map(t => ({
                ...
                y: t.y,
                ...(canvas.isSmartModel ? {
                    task: t.task ? t.task.task : 'x = x + 1',
                    tokenOrder: t.tokenOrder || 'FIFO',
                    passOnTrue: t.passOnTrue ?? true,
                    passOnFalse: t.passOnFalse ?? false,
                    passPreviousValue: t.passPreviousValue ?? true
                } : {})
            })),
            arcs: [],
